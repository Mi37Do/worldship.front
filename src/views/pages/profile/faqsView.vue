  ...
  <div class="w-full h-full flex flex-col overflow-hidden">
    <top-app-bar>
      <template #title>
        ...
        <span class="pixa-title flex-1">faq's</span>
      </template>
    </top-app-bar>
    ...
    <div v-else class="w-full flex-1 py-4 flex flex-col gap-4 overflow-hidden">
      ...
      <div class="w-full h-full overflow-auto flex justify-center pb-4">
        <div
          class="w-full h-fit max-w-screen-lg bg-white rounded-lg border border-slate-200 flex flex-col gap-4 pt-4 px-6 pb-16">
